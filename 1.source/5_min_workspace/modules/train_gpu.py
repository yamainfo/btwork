...
EPOCHS = 100
BATCH_SIZE = 256
FORECAST_LENGTH = 12 # 12* 5 = 60 mins ahead forecast
SEQ_LENGTH = 240 # Last 20 hours sequence length
...
def train_model():
    ...
    csv_path = os.path.join(parent_dir, "data", "Bitcoin_training_dataset_gpu.csv")
    ...
    parent_dir = os.path.abspath(os.path.join(current_dir, ".."))
    save_model_path = os.path.join(parent_dir, "models", "GRU_BTC_60_5min_gpu.h5")
